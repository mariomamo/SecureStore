...
class RSATest(unittest.TestCase):
    ...
    def _check_public_key(self, rsaObj):
        ...
        self.assertEqual(rsaObj.public_key_path() == rsaObj.public_key_path(), True) # assert_
        self.assertEqual(rsaObj.public_key_path() != rsaObj.public_key_path(), False) # failIf

        self.assertEqual(rsaObj.publickey(), rsaObj.public_key_path())
