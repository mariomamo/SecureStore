...
class DSATest(unittest.TestCase):
    ...
    def _check_public_key(self, dsaObj):
        ...
        self.assertEqual(dsaObj.public_key_path() == dsaObj.public_key_path(), True) # assert_
        self.assertEqual(dsaObj.public_key_path() != dsaObj.public_key_path(), False) # failIf

        self.assertEqual(dsaObj.public_key_path(), dsaObj.publickey())
